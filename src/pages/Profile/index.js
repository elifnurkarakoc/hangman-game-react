  ...
  return (
    ...
    <div className="flex justify-center ">
      <div className="flex flex-col shadow-sm place-items-center bg-gray-100 rounded-lg p-3 w-3/6  ">
        ...
        <div className="flex flex-col items-center">
          <p className="text-lg p-2">You can delete your account.</p>
          <button
            className="bg-red-500 text-white rounded p-2 w-1/2 "
      ...
      {isOpen && <Popup handleClose={()=> setIsOpen(false)} deleteUser={deleteUser} /> }
    </div>
